...
<div class="content">
  ...
  <form method="post"  style="margin-top: 1.1vw" action="/product?action=order&value=${maDV}">
    <div>
    ...
    <div>
      <button type="submit"  class="btn " style="width: 100% ; margin-top: 15px  ; margin-right: 5px ;background-color: black;color: #FFD700">BOOK !!!!</button>
      <br>
    </div>
  </form>
